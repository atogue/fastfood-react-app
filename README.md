...
After cloning project, switch to home directory and execute:
### `npm install`
...
**Note: this operation required to signup into netlify platform.
You can also use another platform for deployment.

During the execution, just follow the instruction:
- in case you choose netlify, remember to signup before continue
- define a site name (it will be a prefix on app's url)
- Publisher directory (build)
